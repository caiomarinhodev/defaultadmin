...
function luxurytax() {
	addAlert(player[turn].name + " pagou $100 por Taxa de Luxuria.");
...
square[4] = new Square("City Tax", "Pague $200", "#FFFFFF");
...
square[30] = new Square("Va para Cadeira", "Vá diretamente para a cadeia. Não passe no Inicio. Não colete US $ 200.", "#FFFFFF");
...
square[38] = new Square("LUXURY TAX", "Pague $100", "#FFFFFF");
